...
import br.com.treinaweb.gerenciadortarefas.modelos.Usuario;
import br.com.treinaweb.gerenciadortarefas.repositorios.RepositorioTarefa;
...
public class TarefasController {
	...
	public ModelAndView inserir(@ Valid Tarefa tarefa, BindingResult result, HttpServletRequest request) {
		...
		if(tarefa.getDataExpiracao() == null) {
			...
			result.rejectValue("dataExpiracao", "tarefa.dataExpiracaoInvalida", "Data obrigatória.");
		}else {
			
			if(tarefa.getDataExpiracao().before(new Date())) {
				result.rejectValue("dataExpiracao", "tarefa.dataExpiracaoInvalida", "Data inválida.");
			}
		}
